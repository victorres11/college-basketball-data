...
def get_season_rankings(team_name: str, season: int) -> Dict[str, Any]:
    ...
    # Comprehensive mapping for major conferences
    team_season_mappings = {
        ...
        'arizona state': f"{season_str} Arizona State Sun Devils men's basketball team",
        'asu': f"{season_str} Arizona State Sun Devils men's basketball team",
        'baylor': f"{season_str} Baylor Bears men's basketball team",
        'byu': f"{season_str} BYU Cougars men's basketball team",
        'brigham young': f"{season_str} BYU Cougars men's basketball team",
        'cincinnati': f"{season_str} Cincinnati Bearcats men's basketball team",
        'colorado': f"{season_str} Colorado Buffaloes men's basketball team",
        'houston': f"{season_str} Houston Cougars men's basketball team",
        'iowa state': f"{season_str} Iowa State Cyclones men's basketball team",
        'kansas': f"{season_str} Kansas Jayhawks men's basketball team",
        'kansas state': f"{season_str} Kansas State Wildcats men's basketball team",
        'oklahoma state': f"{season_str} Oklahoma State Cowboys basketball team",
        'tcu': f"{season_str} TCU Horned Frogs men's basketball team",
        'texas christian': f"{season_str} TCU Horned Frogs men's basketball team",
        'texas tech': f"{season_str} Texas Tech Red Raiders basketball team",
        'ucf': f"{season_str} UCF Knights men's basketball team",
        'central florida': f"{season_str} UCF Knights men's basketball team",
        'utah': f"{season_str} Utah Utes men's basketball team",
        'west virginia': f"{season_str} West Virginia Mountaineers men's basketball team",

        # SEC
        'alabama': f"{season_str} Alabama Crimson Tide men's basketball team",
        'arkansas': f"{season_str} Arkansas Razorbacks men's basketball team",
        'auburn': f"{season_str} Auburn Tigers men's basketball team",
        'florida': f"{season_str} Florida Gators men's basketball team",
        'georgia': f"{season_str} Georgia Bulldogs basketball team",
        'kentucky': f"{season_str} Kentucky Wildcats men's basketball team",
        'lsu': f"{season_str} LSU Tigers basketball team",
        'louisiana state': f"{season_str} LSU Tigers basketball team",
        'mississippi state': f"{season_str} Mississippi State Bulldogs men's basketball team",
        'missouri': f"{season_str} Missouri Tigers men's basketball team",
        'oklahoma': f"{season_str} Oklahoma Sooners men's basketball team",
        'ole miss': f"{season_str} Ole Miss Rebels men's basketball team",
        'mississippi': f"{season_str} Ole Miss Rebels men's basketball team",
        'south carolina': f"{season_str} South Carolina Gamecocks men's basketball team",
        'tennessee': f"{season_str} Tennessee Volunteers basketball team",
        'texas': f"{season_str} Texas Longhorns men's basketball team",
        'texas a&m': f"{season_str} Texas A&M Aggie men's basketball team",
        'vanderbilt': f"{season_str} Vanderbilt Commodores men's basketball team",

        # ACC
        'boston college': f"{season_str} Boston College Eagles men's basketball team",
        'clemson': f"{season_str} Clemson Tigers men's basketball team",
        'duke': f"{season_str} Duke Blue Devils men's basketball team",
        'florida state': f"{season_str} Florida State Seminoles men's basketball team",
        'georgia tech': f"{season_str} Georgia Tech Yellow Jackets men's basketball team",
        'louisville': f"{season_str} Louisville Cardinals men's basketball team",
        'miami': f"{season_str} Miami Hurricanes men's basketball team",
        'miami (fl)': f"{season_str} Miami Hurricanes men's basketball team",
        'nc state': f"{season_str} NC State Wolfpack men's basketball team",
        'north carolina state': f"{season_str} NC State Wolfpack men's basketball team",
        'north carolina': f"{season_str} North Carolina Tar Heels men's basketball team",
        'unc': f"{season_str} North Carolina Tar Heels men's basketball team",
        'notre dame': f"{season_str} Notre Dame Fighting Irish men's basketball team",
        'pittsburgh': f"{season_str} Pittsburgh Panthers men's basketball team",
        'pitt': f"{season_str} Pittsburgh Panthers men's basketball team",
        'syracuse': f"{season_str} Syracuse Orange men's basketball team",
        'virginia': f"{season_str} Virginia Cavaliers men's basketball team",
        'virginia tech': f"{season_str} Virginia Tech Hokies men's basketball team",
        'wake forest': f"{season_str} Wake Forest Demon Deacons men's basketball team",

        # Big East
        'butler': f"{season_str} Butler Bulldogs men's basketball team",
        'creighton': f"{season_str} Creighton Bluejays men's basketball team",
        'depaul': f"{season_str} DePaul Blue Demons men's basketball team",
        'georgetown': f"{season_str} Georgetown Hoyas men's basketball team",
        'marquette': f"{season_str} Marquette Golden Eagles men's basketball team",
        'providence': f"{season_str} Providence Friars men's basketball team",
        'seton hall': f"{season_str} Seton Hall Pirates men's basketball team",
        'st. john\'s': f"{season_str} St. John's Red Storm men's basketball team",
        'st john\'s': f"{season_str} St. John's Red Storm men's basketball team",
        'villanova': f"{season_str} Villanova Wildcats men's basketball team",
        'xavier': f"{season_str} Xavier Musketeers men's basketball team",
        'uconn': f"{season_str} UConn Huskies men's basketball team",
        'connecticut': f"{season_str} UConn Huskies men's basketball team",

        # Other notable programs
        'gonzaga': f"{season_str} Gonzaga Bulldogs men's basketball team",
        'saint mary\'s': f"{season_str} Saint Mary's Gaels men's basketball team",
        'san diego state': f"{season_str} San Diego State Aztecs men's basketball team",
        'sdsu': f"{season_str} San Diego State Aztecs men's basketball team",
        'memphis': f"{season_str} Memphis Tigers men's basketball team",
        'wichita state': f"{season_str} Wichita State Shockers men's basketball team",
        'vcu': f"{season_str} VCU Rams men's basketball team",
        'dayton': f"{season_str} Dayton Flyers men's basketball team",
