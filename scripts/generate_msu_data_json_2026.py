#!/usr/bin/env python3
"""
Generate Michigan State Scouting Data as JSON for 2026 Season (2025-26 academic year)
import sys
import os
...
def generate_msu_data_json_2026():
    """Generate consolidated JSON file with all Michigan State data for 2026 season."""
    ...
    game_data = api.get_player_game_stats_by_date('2025-11-04', '2026-03-10', "michigan state")
    
    print("Fetching roster data...")
    roster_data = api.get_team_roster(2026, "michigan state")
    
    print("Fetching recruiting data...")
    recruiting_data = api.get_recruiting_players("Michigan State")
    
    print("Fetching team game stats...")
    team_game_stats = api.get_team_game_stats(2026, '2025-11-04', '2026-03-10', "michigan state", "regular")
    
    print("Fetching player season stats with rankings...")
    player_season_stats = api.get_player_season_stats(2026, "michigan state", "regular")
    
    print("Fetching team season stats with rankings...")
    team_season_stats = api.get_team_season_stats(2026, "michigan state", "regular")
    ...
    output_file = 'data/2026/msu_scouting_data_2026.json'
