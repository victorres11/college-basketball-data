#!/usr/bin/env python3
"""
Generate Eastern Washington Scouting Data as JSON for 2026 Season (2025-26 academic year)
import sys
import os
...
def generate_eastern_washington_data_json_2026():
    """Generate consolidated JSON file with all Eastern Washington data for 2026 season."""
    print("Fetching Eastern Washington data...")
    api = CollegeBasketballAPI()
    
    # Fetch data
    print("Fetching game data for Eastern Washington players...")
    game_data = api.get_player_game_stats_by_date('2025-11-04', '2026-03-17', "eastern washington")
    
    print("Fetching roster data...")
    roster_data = api.get_team_roster(2026, "eastern washington")
    ...
    team_game_stats = api.get_team_game_stats(2026, '2025-11-04', '2026-03-17', "eastern washington", "regular")
    
    print("Fetching player season stats with rankings...")
    player_season_stats = api.get_player_season_stats(2026, "eastern washington", "regular")
    
    print("Fetching team season stats with rankings...")
    team_season_stats = api.get_team_season_stats(2026, "eastern washington", "regular")
    ...
    output_file = 'data/2026/eastern_washington_scouting_data_2026.json'
...
if __name__ == '__main__':
    generate_eastern_washington_data_json_2026()
