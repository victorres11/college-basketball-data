#!/usr/bin/env python3
"""
Generate UCLA Scouting Data as JSON
import sys
import os
...
def generate_ucla_data_json():
    """Generate consolidated JSON file with all UCLA data."""
    print("Fetching UCLA data...")
    api = CollegeBasketballAPI()
    
    # Fetch data
    print("Fetching game data for UCLA players...")
    game_data = api.get_player_game_stats_by_date('2024-11-04', '2025-03-17', "ucla")
    
    print("Fetching roster data...")
    roster_data = api.get_team_roster(2025, "ucla")
    ...
    # Save to JSON file
    output_file = 'ucla_scouting_data.json'
