#!/usr/bin/env python3
"""
Generate Oregon Scouting Data as JSON for 2026 Season (2025-26 academic year)
...
def generate_oregon_data_json_2026():
    """Generate consolidated JSON file with all Oregon data for 2026 season."""
    print("Fetching Oregon data...")
    api = CollegeBasketballAPI()
    
    # Fetch data
    print("Fetching game data for Oregon players...")
    game_data = api.get_player_game_stats_by_date('2025-11-04', '2026-03-17', "oregon")
    
    print("Fetching roster data...")
    roster_data = api.get_team_roster(2026, "oregon")
    
    print("Fetching recruiting data...")
    recruiting_data = api.get_recruiting_players("Oregon")
    
    print("Fetching team game stats...")
    team_game_stats = api.get_team_game_stats(2026, '2025-11-04', '2026-03-17', "oregon", "regular")
    
    print("Fetching player season stats with rankings...")
    player_season_stats = api.get_player_season_stats(2026, "oregon", "regular")
    
    print("Fetching team season stats with rankings...")
    team_season_stats = api.get_team_season_stats(2026, "oregon", "regular")
    
    print("Calculating conference rankings...")
    conference_rankings = calculate_conference_rankings(api, "Oregon", "Big Ten")
    ...
    for player_name_lower in sorted(all_players_to_process):
        ...
        historical_seasons = get_player_career_season_stats(api, player_name, "oregon")
    ...
    output_file = 'data/2026/oregon_scouting_data_2026.json'
...
if __name__ == '__main__':
    generate_oregon_data_json_2026()
